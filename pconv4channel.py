...
class PConvUNet():
    ...
    def discriminator(self):
        ...
        # inputsDepth = np.repeat(inputsDepth, 3, -1)
        # print(inputsDepth.shape)
        # exit()
    ...
    def plot_example(self, inpRGBD, targetRGBD, inputRGB, inputDepth, genrgb, gendepth,e, i):
        ...
        plt.savefig(f'res4channel/epoch_{e}_iter_{i:05d}.png', bbox_inches='tight')
...
loss_arr = model.train(epochs = 50, plot_progress = True)

np.save('FourChannellossArray', loss_arr)